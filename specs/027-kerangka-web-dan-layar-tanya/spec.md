...
| Status | **Gerbang 1 lolos** — 25 September 2026 (KB-124). Cakupan disempitkan atas TK-65 (KB-125). Menunggu Gerbang 2 |
...
Tanya, tersambung ke `POST /api/v1/tanya`. Riwayat percakapan dikeluarkan
atas TK-65 — lihat bagian Perubahan cakupan.
...
- **Riwayat percakapan (FR-F09)** — dikeluarkan atas TK-65: rutenya ada tetapi
  tidak ada jalur yang menulis riwayat; penyambungannya fitur 028
...
| R-11 | **Dikeluarkan 25 September 2026 (KB-125).** Semula: menampilkan daftar percakapan dan membuka satu percakapan (FR-F09). Riwayat tidak pernah ditulis backend (TK-65); penyambungannya fitur 028. Nomor dipertahankan agar ketertelusuran tidak bergeser |
...
## Perubahan cakupan sesudah Gerbang 1

**Diputus pemegang Gerbang 1–4, 25 September 2026: pilihan A (KB-125).**

TK-65 ditemukan saat mengerjakan K-1: `Percakapan.catat` hanya dipanggil dari
uji, penangan `/tanya` tidak mencatat giliran, dan permintaannya tidak memuat
pengenal percakapan. R-11 tidak dapat dipenuhi tanpa mengubah backend, dan
R-16 melarangnya.

Putusannya: **R-11 dikeluarkan** dan irisan menjadi layar Tanya saja.
Penyambungan riwayat menjadi **fitur 028**, sebab ia menuntut bidang
permintaan baru yang harus ditulis ke D-14 lebih dulu.
...
| R-11 | Dikeluarkan — TK-65, fitur 028 |
